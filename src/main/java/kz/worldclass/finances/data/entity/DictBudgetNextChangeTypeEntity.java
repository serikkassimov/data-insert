...
import static kz.worldclass.finances.data.entity.DictBudgetNextChangeTypeEntity.*;
...
public class DictBudgetNextChangeTypeEntity extends BaseDictEntity {
    public static final String TABLE = "DICT_BUDGET_NEXT_CHANGE_TYPE";
}